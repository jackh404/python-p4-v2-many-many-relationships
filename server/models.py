...
class Employee(db.Model):
    ...
    meetings = db.relationship(
        'Meeting', secondary = employees_meetings, back_populates = 'employees'
    )
...
class Meeting(db.Model):
    ...
    employees = db.relationship(
        'Employee', secondary=employees_meetings, back_populates = 'meetings'
    )
...
class Project(db.Model):
    ...
    #Association proxy to get employees for this project throught assignments
